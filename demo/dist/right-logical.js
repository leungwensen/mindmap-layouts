...
const lineColor = new __WEBPACK_IMPORTED_MODULE_0_zero_colors___default.a(randomColor()).toGrey().toString(true);
function drawBezierCurveToChild(n, c, ctx) {
  ...
  ctx.bezierCurveTo(roundInt(beginX + (n.hgap + c.hgap) / 2), beginY, roundInt(endX - (n.hgap + c.hgap) / 2), endY, endX, endY);
  ctx.stroke();
}
